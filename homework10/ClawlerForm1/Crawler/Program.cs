...
namespace Crawler
{
    public class SimpleCrawler
    {
        ...
        public BlockingCollection<string> completedUrls { get; set; } = new BlockingCollection<string>();
        ...
        public void Crawl()
        {
            ...
            while (true)
            {
                ...
                for(int i =0;i<urls.Count();i++)
                {
                    ...
                    if (completedUrls.Contains(current)) continue;
                    ...
                    Parse(html, current);
                    //Parallel.Invoke(() => Crawl(), () => Crawl());//解析,并加入新的链接
        ...
        private void Parse(string html, string current)
        {
            ...
            foreach (Match match in matches)
            {
                ...
                if (strRef.Length == 0 || strRef.Contains("javascript")) continue;
                if (!completedUrls.Contains(strRef)) urls.Enqueue(strRef);
            }
        }
    }
}
